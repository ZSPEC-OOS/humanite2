    ...
    <footer className="border-t border-gray-200 bg-white">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 px-6 py-10 text-center md:flex-row md:justify-between md:text-left">
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">More human ideas for a brighter tomorrow.</p>
        </div>
        ...
        <p className="text-xs text-gray-400">© {new Date().getFullYear()} Humanite. All rights reserved.</p>
      </div>
    </footer>
  )
}
